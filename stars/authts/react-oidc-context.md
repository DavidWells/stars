...
updatedAt: '2025-02-23T17:41:11Z'
language: TypeScript
license: MIT
branch: main
stars: 791
...
isFork: false
hasReadMe: true
refreshedAt: '2025-02-25T19:59:26.355Z'
description: >-
  Lightweight auth library based on oidc-client-ts for React single page
  applications (SPA). Support for hooks and higher-order components (HOC).
tags:
  - hooks
  - oidc
  - oidc-client
