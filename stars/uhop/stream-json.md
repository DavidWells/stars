...
homepage: ''
starredAt: '2025-09-08T00:46:57Z'
createdAt: '2013-08-11T02:17:41Z'
updatedAt: '2025-10-18T06:35:33Z'
language: JavaScript
license: NOASSERTION
branch: master
stars: 1120
...
isFork: false
hasReadMe: true
refreshedAt: '2025-10-18T22:29:47.933Z'
description: >-
  The micro-library of Node.js stream components for creating custom JSON
  processing pipelines with a minimal memory footprint. It can parse JSON files
  far exceeding available memory streaming individual primitives using a
  SAX-inspired API.
tags:
  - javascript-objects
  - parse-json-files
