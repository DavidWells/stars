...
createdAt: '2020-07-18T07:32:07Z'
updatedAt: '2025-02-20T22:59:08Z'
language: JavaScript
license: MIT
branch: master
stars: 593
...
isFork: false
hasReadMe: true
refreshedAt: '2025-02-25T21:18:42.256Z'
description: >-
  Dynamically generated Github Contribution Stats. :chart_with_upwards_trend:
  :calendar:
tags:
  - generator
  - github-profile
...
The rating scale is based on the [academic grading system](https://en.wikipedia.org/wiki/Academic_grading_in_Japan) used in Japan. I was fascinated with that ("S" is rarely given :joy:). We also used some of the common formulas in statistics like (Mean, SD, Z-Score, etc.) to get the final scores based on the 4 data sets (Commits, Pull Requests, Issues, and Code Reviews). If you want to check the technical details of the ratings, here is the file [ContributionRatings.js](https://github.com/LordDashMe/github-contribution-stats/blob/master/src/ContributionRatings.js).
...
For those who are currently using it right now with their Github README profile:
  ...
  - [mdirshaddev](https://github.com/mdirshaddev)
  ...
  - [AndrewMbugua](https://github.com/AndrewMbugua)

  - [yashshrivastavaa](https://github.com/yashshrivastavaa)

  - [igarridot](https://github.com/igarridot)

  - [manojbahadur](https://github.com/manojbahadur)

  - [sugatoray](https://github.com/sugatoray)

  - [cherubinifranco](https://github.com/cherubinifranco)
