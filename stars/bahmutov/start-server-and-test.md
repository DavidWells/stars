---
repo: bahmutov/start-server-and-test
url: 'https://github.com/bahmutov/start-server-and-test'
homepage: null
starredAt: '2025-09-06T00:55:49Z'
createdAt: '2017-11-03T14:18:11Z'
...
isFork: false
hasReadMe: true
refreshedAt: '2025-10-18T22:29:47.896Z'
description: >-
  Starts server, waits for URL, then runs test command; when the tests end,
  shuts down server
tags:
  - cli
  - server
