...
createdAt: '2019-10-15T22:04:52Z'
updatedAt: '2025-02-24T23:52:09Z'
language: Python
license: MIT
branch: master
stars: 8061
...
isFork: false
hasReadMe: true
refreshedAt: '2025-02-25T20:22:10.970Z'
description: >-
  CLI tool and python library that converts the output of popular command-line
  tools, file-types, and common strings to JSON, YAML, or Dictionaries. This
  allows piping of output to tools like jq and simplifying automation scripts.
tags:
  - bash
  - bash-scripting
  - cli
