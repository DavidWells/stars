...
createdAt: '2021-07-25T15:56:43Z'
updatedAt: '2022-12-14T10:03:59Z'
language: JavaScript
license: NA
branch: master
stars: 4
...
isFork: false
hasReadMe: true
refreshedAt: '2025-02-25T20:37:44.856Z'
description: Examples of PartiQL with DynamoDB on NodeJS SDK.
tags:
  - aws
  - aws-lambda
  - dynamodb
...
```bash
copa-america-partiql-demo$ sam build
```
...
```bash
copa-america-partiql-demo$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
copa-america-partiql-demo$ sam local start-api
copa-america-partiql-demo$ curl http://localhost:3000/
```
...
```bash
copa-america-partiql-demo$ sam logs -n HelloWorldFunction --stack-name copa-america-partiql-demo --tail
```
...
```bash
copa-america-partiql-demo$ cd hello-world
...
```bash
aws cloudformation delete-stack --stack-name copa-america-partiql-demo
```
