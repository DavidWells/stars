---
repo: aliyun/react-visual-modeling
url: 'https://github.com/aliyun/react-visual-modeling'
homepage: ''
starredAt: '2021-03-11T03:38:13Z'
createdAt: '2021-02-22T06:51:43Z'
updatedAt: '2024-12-03T08:54:55Z'
language: JavaScript
license: MIT
branch: master
stars: 142
...
isFork: false
hasReadMe: true
refreshedAt: '2025-02-25T21:17:58.815Z'
description: >-
  A DAG React Component for visualization modeling, suitable for UML, database
  modeling, data warehouse
  construction.(一个基于React的数据可视化建模的DAG图，适用于UML，数据库建模，数据仓库建设等业务)
tags:
  - dag
