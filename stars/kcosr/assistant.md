---
repo: kcosr/assistant
url: 'https://github.com/kcosr/assistant'
homepage: null
starredAt: '2026-04-20T05:02:17Z'
createdAt: '2026-01-11T17:25:17Z'
updatedAt: '2026-06-16T00:14:17Z'
language: TypeScript
license: NA
branch: main
stars: 86
...
isFork: false
hasReadMe: true
refreshedAt: '2026-07-05T01:53:43.604Z'
description: >-
  Panel-based personal assistant with a plugin architecture for productivity
  workflows. AI agents share a workspace of notes, lists and other panels with
  the user. Supports Claude Code, Codex, and pi CLI agents with text and voice
  interfaces. Extend with custom plugins or use built-in plugins exported as
  skills with CLIs.
tags: []
---
