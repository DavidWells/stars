...
createdAt: '2013-09-26T17:39:05Z'
updatedAt: '2025-02-25T20:33:05Z'
language: JavaScript
license: MIT
branch: master
stars: 7164
...
description: >-
  A graph node engine and editor written in Javascript similar to PD or UDK
  Blueprints, comes with its own editor in HTML5 Canvas2D. The engine can run
  client side or server side using Node. It allows to export graphs as JSONs to
  be included in applications independently.
tags:
  - blueprints
  - canvas2d
  - editor
