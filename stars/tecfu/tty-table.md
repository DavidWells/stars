---
repo: tecfu/tty-table
url: 'https://github.com/tecfu/tty-table'
homepage: 'https://www.npmjs.com/package/tty-table'
starredAt: '2025-04-13T15:53:02Z'
createdAt: '2015-07-01T01:09:36Z'
updatedAt: '2025-04-13T15:53:03Z'
language: JavaScript
license: MIT
branch: master
stars: 294
...
isFork: false
hasReadMe: true
refreshedAt: '2025-04-25T21:49:13.388Z'
description: >-
  Terminal table for Windows, Linux, and MacOS. Written in nodejs. Also works in
  browser console. Word wrap, padding, alignment, colors, Asian character
  support, per-column callbacks, and you can pass rows as objects or arrays.
  Backwards compatible with Automattic/cli-table.
tags:
  - cli-table
  - nodejs
  - table
