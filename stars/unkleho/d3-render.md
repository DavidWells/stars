...
createdAt: '2020-04-19T07:54:39Z'
updatedAt: '2024-12-29T21:31:17Z'
language: TypeScript
license: MIT
branch: master
stars: 178
...
isFork: false
hasReadMe: true
refreshedAt: '2025-02-25T20:37:31.429Z'
description: >-
  Declarative and reusable D3. Replace select, append, data and more with one
  function.
tags:
  - d3
---
...
A D3 selector string, HTML node or D3 selection to specify the root element where `render` will run. Works a bit like [d3.select](https://github.com/d3/d3-selection#select). Most common usage is with an id or class.
